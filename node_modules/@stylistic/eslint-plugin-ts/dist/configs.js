...
const baseRule$e = utils.getESLintCoreRule("block-spacing");
var blockSpacing = utils.createRule({
  ...
  create(context, [whenToApplyOption]) {
    ...
    const baseRules = baseRule$e.create(context);
...
const baseRule$d = utils.getESLintCoreRule("brace-style");
var braceStyle = utils.createRule({
  ...
  meta: {
    ...
    fixable: baseRule$d.meta.fixable,
    hasSuggestions: baseRule$d.meta.hasSuggestions,
    schema: baseRule$d.meta.schema
  },
  defaultOptions: ["1tbs"],
  create(context) {
...
const baseRule$c = utils.getESLintCoreRule("comma-dangle");
...
var commaDangle = utils.createRule({
  ...
  create(context, [options]) {
    const rules = baseRule$c.create(context);
    const sourceCode = context.sourceCode;
...
const baseRule$b = utils.getESLintCoreRule("indent");
...
var indent = utils.createRule({
  ...
  create(context, optionsWithDefaults) {
    ...
    const rules = baseRule$b.create(contextWithDefaults);
...
const baseRule$a = utils.getESLintCoreRule("key-spacing");
const baseSchema$1 = Array.isArray(baseRule$a.meta.schema) ? baseRule$a.meta.schema[0] : baseRule$a.meta.schema;
...
const baseRule$9 = utils.getESLintCoreRule("keyword-spacing");
const baseSchema = Array.isArray(baseRule$9.meta.schema) ? baseRule$9.meta.schema[0] : baseRule$9.meta.schema;
...
var keywordSpacing = utils.createRule({
  ...
  create(context, [options]) {
    ...
    const sourceCode = context.sourceCode;
    const baseRules = baseRule$9.create(context);
    return {
      ...baseRules,
      TSAsExpression(node) {
...
const baseRule$8 = utils.getESLintCoreRule("lines-around-comment");
...
var linesAroundComment = utils.createRule({
  ...
  meta: {
    ...
    fixable: baseRule$8.meta.fixable,
  ...
  create(context, [_options]) {
    ...
    const rules = baseRule$8.create(proxiedContext);
    return {
      Program(node) {
        rules.Program(node);
        comments.forEach((token) => {
...
const baseRule$7 = utils.getESLintCoreRule("lines-between-class-members");
const schema = Object.values(
  utils.deepMerge(
    { ...baseRule$7.meta.schema },
    {
      1: {
        properties: {
          exceptAfterOverload: {
...
const baseRule$6 = utils.getESLintCoreRule("no-extra-parens");
...
const baseRule$5 = utils.getESLintCoreRule("no-extra-semi");
var noExtraSemi = utils.createRule({
  ...
  meta: {
    ...
    fixable: "code",
    hasSuggestions: baseRule$5.meta.hasSuggestions,
    schema: baseRule$5.meta.schema,
    messages: baseRule$5.meta.messages
  },
  defaultOptions: [],
  create(context) {
...
const baseRule$4 = utils.getESLintCoreRule("object-curly-spacing");
